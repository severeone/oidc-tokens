...
import co.kernelnetworks.oidc.auth.tokens.util.InvalidIDToken;
import co.kernelnetworks.oidc.auth.tokens.util.InvalidIDTokenKey;
 ...
 * <pre>
 * {
 *   "iss"                        : "auth.casemedicalresearch.com",
 *   "sub"                        : "12345",
 *   "aud"                        : "client_id",
 *   "exp"                        : 1300819380,
 *   "iat"                        : 1300712330,
...
public final class IDToken {
    ...
    private static IDToken readFromString(final String s,
                                          JWKSource<CaseMedicalResearchSecurityContext> keySource)
        throws InvalidIDToken, InvalidIDTokenKey {
        ConfigurableJWTProcessor<CaseMedicalResearchSecurityContext> jwtProcessor =
                new DefaultJWTProcessor<>();

        JWSKeySelector<CaseMedicalResearchSecurityContext> keySelector =
	...
	public boolean issuerIsValid() {
		return claims.getIssuer().equals(CaseMedicalResearchSecurityContext.ISSUER);
	}
