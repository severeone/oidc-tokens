...
public final class AccessToken {
	...
	public static class Builder {
		...
		private final JWTClaimsSet.Builder jwtClaimsSetBuilder = new JWTClaimsSet.Builder()
				.issuer(CaseMedicalResearchSecurityContext.ISSUER)
				.audience(new ArrayList<String>(){{
					add(CaseMedicalResearchSecurityContext.API_ENDPOINT);
					add(CaseMedicalResearchSecurityContext.USER_INFO_ENDPOINT);
				}});
	...
	public static AccessToken decryptFromString(final String s, final String key)
		...
		ConfigurableJWTProcessor<CaseMedicalResearchSecurityContext> jwtProcessor =
				new DefaultJWTProcessor<>();
		JWKSource<CaseMedicalResearchSecurityContext> jweKeySource = new ImmutableSecret<>(secretKeyFromString(key));
		JWEKeySelector<CaseMedicalResearchSecurityContext> jweKeySelector = new JWEDecryptionKeySelector<>(
	...
	public boolean issuerIsValid() {
		return CaseMedicalResearchSecurityContext.ISSUER.equals(claims.getIssuer());
	}
